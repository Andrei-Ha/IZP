<%@ Page Title="Архив Пинских ЭС" MasterPageFile="~/Site.master" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Archive_PES.aspx.cs" Inherits="Archive_PES" %>
...
<script type="text/javascript">
    ...
    function Func_Redir() {
        window.location.href = "SuperUSER/DelArch_PES.aspx";
    }
</script>
    ...
    <radw:RadWindowManager ID="RadWindowManager1" runat="server" Skin="WebBlue" Language="ru-RU">
                <Windows>
                    <radw:RadWindow ID="InsertValListDialog" runat="server" Title="Кол-во СЗ испытанных и забракованных" 
                         />
                </Windows>
        ...
        <table width="100%">
            <tr>
                <td style="text-align:left">
                    <strong>Архив испытаний средств защиты Пинских ЭС</strong>
                </td>
                <td style="text-align:right">
                    <asp:Button ID="ButtonDelArch" runat="server" Text="удаление архива" OnClientClick="Func_Redir(); return false;" style="background-color:Teal; color:White" />
                </td>
            </tr>
        </table>          
<fieldset style="vertical-align: middle; text-align: center; background-color:#DCDCDC;">
    <legend style="color: #A0522D; font-weight:bold; font-style: italic; font-size: 9px;">фильтр</legend>
        ...
        <fieldset style="vertical-align: middle; text-align: left;">
                <legend style="color: gray; font-weight:normal; font-style: italic; font-size: 9px;">название подразделения и бригады</legend>
    ...
    <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
        ...
        AllowPaging="True" PagerSettings-Mode="NumericFirstLast" PagerSettings-PageButtonCount="60" 
        ...
        <Columns>
                         <asp:BoundField HeaderText="№ пр-ла" ItemStyle-Width="15px" ItemStyle-HorizontalAlign="Right" SortExpression="NUM_P" DataField="NUM_P" />
                          <asp:TemplateField HeaderText="Название подразделения" SortExpression="NAME_ORG" >
