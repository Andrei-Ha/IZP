...
public partial class logistics : System.Web.UI.Page
{
    ...
    protected void ButtonSave_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridItem item in RadGrid2.MasterTableView.Items)
        {
            ...
            if (checkBox.Checked) {
                ...
                string commandString = "UPDATE IZP_BOOK SET CELL=" + st_cell + " WHERE ID_=" + dataitem.GetDataKeyValue("ID").ToString();
                OleDbCommand myCommand = new OleDbCommand(commandString, myConnection);
    ...
    protected void ButtonFilter_Click(object sender, EventArgs e)
    {
        ...
        //SqlDataSource2.SelectCommand = "SELECT IZP_BOOK.ID_ AS ID,K_ORGAN,K_BRIG,NAME_ORG,NAME_BRIG,IZP_BOOK.K_GROUP,NAME_GROUP,K_NAME,NAME,CELL,FAC_NUM, DATE_PROT,EXEC_SIGN FROM IZP_BOOK,IZP_SPR_ORG,IZP_SPR_BRIG,IZP_SPR_PERIOD,IZP_SPR_PROTECT WHERE K_ORGAN=IZP_SPR_ORG.CODE AND K_BRIG=IZP_SPR_BRIG.CODE AND IZP_BOOK.K_GROUP=NUM_PROTCL AND K_NAME=IZP_SPR_PROTECT.ID_ AND DATE_PROT IS NOT NULL AND EXEC_SIGN=0 " + st_filter_org + st_filter_brig + st_filter_group + "ORDER BY IZP_BOOK.K_GROUP";
        SqlDataSource2.SelectCommand = "SELECT IZP_BOOK.ID_ AS ID,K_ORGAN,K_BRIG,NAME_ORG,NAME_BRIG,IZP_BOOK.K_GROUP,NAME_GROUP,K_NAME,NAME,CELL,FAC_NUM, DATE_PROT,EXEC_SIGN FROM IZP_BOOK,IZP_SPR_ORG,IZP_SPR_BRIG,IZP_SPR_PERIOD,IZP_SPR_PROTECT WHERE K_ORGAN=IZP_SPR_ORG.CODE AND K_BRIG=IZP_SPR_BRIG.CODE AND IZP_BOOK.K_GROUP=NUM_PROTCL AND K_NAME=IZP_SPR_PROTECT.ID_ AND EXEC_SIGN=0 " + st_filter_org + st_filter_brig + st_filter_group + sr_bind_cell +"ORDER BY IZP_BOOK.K_GROUP";
