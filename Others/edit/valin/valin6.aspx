<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="valin6.aspx.cs" Inherits="valin6" %>
...
<body style="background-color:#CEDDFD">
    ...
    <tr>
        <td colspan="2">
            ...
            <legend style="color: blue; font-weight: bold; font-style: italic; font-size: 9px;">Накладка</legend>
                <asp:RadioButton ID="RadioButton3" Text="жесткая" style="font-size:large" 
                    GroupName="tip" runat="server"  AutoPostBack="true" oncheckedchanged="RadioButton1_CheckedChanged"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:RadioButton ID="RadioButton4" Text="гибкая" style="font-size:large" 
                    GroupName="tip" runat="server" Checked="true" AutoPostBack="true" oncheckedchanged="RadioButton1_CheckedChanged"/>
            </fieldset>
        </td>
    </tr>
    <tr>
        <td colspan="2">
            ...
            <fieldset style="vertical-align: middle; text-align: center;">
            <legend style="color: blue; font-weight: bold; font-style: italic; font-size: 9px;">Испытательное напряжение:</legend>
    ...
    <tr>
        <td colspan="2">
            <fieldset style="vertical-align: middle; text-align: center;">
            <legend style="color: blue; font-weight: bold; font-style: italic; font-size: 9px;">Ток протекающий через изделие(гибкая накладка), мА</legend>
                <asp:TextBox ID="c_right" runat="server" Font-Italic="True" MaxLength="20" Width="70px" onkeyup="validate(this)"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RFV_c_right" ControlToValidate="c_right" runat="server" ErrorMessage="поле не должно быть пустым" Display="Dynamic"><img src="../../../Pictures/Warning.png" alt="!" title="поле не должно быть пустым" /></asp:RequiredFieldValidator>
            </fieldset>        
        </td>
    </tr>
    <tr>
