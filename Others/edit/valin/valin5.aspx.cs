...
public partial class valin5 : System.Web.UI.Page
{
    ...
    protected void UpdateFun()
    {
        ...
        string commandStringTEC = "UPDATE IZP_BOOK SET DATE_EXP='" + RadDatePicker_date_exp.SelectedDate.ToString().Substring(0, 10) + "'" + sv_prot + sv_isol + sv_work + sv_wire + sv_indic + sv_indic2 + sc_left + sc_right + sc_pointer + ",RESULT_EXP=" + sresult_exp +
