   ...
   string s_name_brig;
    ...
    protected void RadGrid2_ItemDataBound(object sender, Telerik.WebControls.GridItemEventArgs e)
    {
        ...
        {   string formin="";
            ...
            if (Array.IndexOf(new int[] { 1, 2, 3 },i_group)>=0) { formin = "edit/valin/valin1.aspx?id_="; }
            else
            {
            ...
            if ((RadioButton1.Checked || Session["SIZP_User"].ToString() == "Горегляд А.С.") || (RadioButton1.Checked || Session["SIZP_User"].ToString() == "Приловский Ю.Д."))
            {
            ...
            if (result_exp != "")
            {
                Resul.Text = (result_exp == "1") ? "соответствует" : "<span class=\"styleR\">не соответствует</span>";
