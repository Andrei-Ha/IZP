...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server"> 
    <script type="text/javascript">
        function OpenPrint(arg, arg_spisan) {
            var params = "menubar=no,location=no,resizable=YES,top=50,left=50,scrollbars=yes,status=no,width=400,height=566"
            var params_spisan = "menubar=no,location=no,resizable=YES,top=100,left=100,scrollbars=yes,status=no,width=400,height=566"
            if (arg != "0") {
                window.open(arg, "печать", params);
            }
            if (arg_spisan != "0") {
                window.open(arg_spisan, "печать_списан", params_spisan);
            }
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_to_Pinsk %>" 
        ...
        <tr>
            ...
            <td colspan="3" style=" border-width:thin; border-color:Gray">
        ...
        <tr>
            <td colspan="3" style="text-align:center">
                ...
                <asp:HiddenField ID="HiddenFieldNUM_P" runat="server" Value="пусто" />
        ...
        <tr>
            <td style="text-align:left; vertical-align:bottom">
                <asp:Label ID="Label_DelProtcl" runat="server" Text="удалить нельзя, т.к. протокол уже выдан!" style="font-size:xx-small; color:Red; font-style:italic" visible="false"/>
                <asp:Button runat="server" ID="Button_DelProtcl" style="color:Red" OnClientClick="return confirm('Вы уверены, что хотите удалить этот протокол?');" onclick="Button_DelProtcl_Click" Text="удалить" Visible="false" />
            </td>
            <td style="text-align:left; vertical-align:bottom">
                <asp:Button runat="server" ID="Button_Spisan" style="color:Yellow" 
                    Text="проткл. списан." Visible="false" onclick="Button_Spisan_Click" />
            </td>
            ...
            <AjaxSettings>
                <radA:AjaxSetting AjaxControlID="RadGrid2">
                    <UpdatedControls>
                        ...
                        <radA:AjaxUpdatedControl ControlID="Button_Spisan" />
                        <radA:AjaxUpdatedControl ControlID="Button_Protcl" />
                        <radA:AjaxUpdatedControl ControlID="Button_DelProtcl" />
