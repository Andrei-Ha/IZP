        ...
        <td colspan="3" style="text-align:center" >
            <fieldset style="vertical-align: middle; text-align: center;">
                <legend style="color: blue; font-weight:normal; font-style: italic; font-size: 9px;">название организации и бригады</legend>
                    <asp:DropDownList ID="DropDownListOrg" runat="server" AutoPostBack="true" Width="200px" onselectedindexchanged="DropDownListOrg_SelectedIndexChanged" />
                    <asp:DropDownList ID="DropDownListBrig" runat="server" Width="200px"/>
            </fieldset>
        </td>
    </tr>
    <tr>
