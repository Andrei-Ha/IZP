<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="valin1.aspx.cs" Inherits="valin1" %>
...
<body style="background-color:#CEDDFD">
    ...
    <tr>
        <td>
            <fieldset style="vertical-align: middle; text-align: center;">
            <legend style="color: blue; font-weight: bold; font-style: italic; font-size: 9px;">Ток протекающий через правое изделие, мА</legend>
        ...
        <td>
            <fieldset style="vertical-align: middle; text-align: center;">
            <legend style="color: blue; font-weight: bold; font-style: italic; font-size: 9px;">Ток протекающий через левое изделие, мА</legend>
                <asp:TextBox ID="c_left" runat="server" Font-Italic="True" MaxLength="20" Width="70px" onkeyup="validate(this)"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RFV_c_left" ControlToValidate="c_left" runat="server" ErrorMessage="поле не должно быть пустым" Display="Dynamic"><img src="../../../Pictures/Warning.png" alt="!" title="поле не должно быть пустым" /></asp:RequiredFieldValidator>
            </fieldset>
