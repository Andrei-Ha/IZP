...
public partial class valin6 : System.Web.UI.Page
{
    ...
    protected void UpdateFun()
    {
        ...
        {
            sv_prot = ",V_PROT=" + HiddenField_v.Value;
            sc_right = ",C_RIGHT=NULL";
            sresult_exp = "1";
            if (RadioButton4.Checked == true)
            {
                sc_right = ",C_RIGHT=" + c_right.Text;
                i_maxcurr = 5;
                if (Convert.ToDouble(c_right.Text.Replace(".", ",")) > i_maxcurr)
                {
                    sresult_exp = "0";
                }
            }           
