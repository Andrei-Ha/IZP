<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="valin4.aspx.cs" Inherits="valin4" %>
...
<body style="background-color:#CEDDFD">
    ...
    <tr>
        <td colspan="2">
        <asp:HiddenField ID="HiddenField_v_work" Value="14" runat="server" />
            <fieldset style="vertical-align: middle; text-align: center;">
            <legend style="color: blue; font-weight: bold; font-style: italic; font-size: 9px;">Рабочая часть. Испытано напряжением:</legend>
                <asp:RadioButton ID="RadioButton3" Text="14кВ" style="font-size:large" 
                    GroupName="works" runat="server" Checked="true" oncheckedchanged="RadioButton3_CheckedChanged" AutoPostBack="true" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:RadioButton ID="RadioButton4" Text="-" style="font-size:large" 
                    GroupName="works" runat="server" oncheckedchanged="RadioButton4_CheckedChanged" AutoPostBack="true" />
            </fieldset>
        </td>
    </tr>
    <tr>
        <td colspan="2">
            <fieldset style="vertical-align: middle; text-align: center;">
            <legend style="color: blue; font-weight: bold; font-style: italic; font-size: 9px;">Напряжение индикации, кВ</legend>
